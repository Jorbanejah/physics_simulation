...
class DoublePendulumSimulator:
    ...
    def run(self, method: IntegrationMethod = IntegrationMethod.RADAU, linearized: bool = False, output_times: np.ndarray | None = None) -> Result:
        """
        Parameters
        ----------
        method : IntegrationMethod
            Integration algorithm to use: RADAU, RK45, DOP853, BDF. Recommended: RADAU for best energy.
        linearized : bool
